          ...
          <Card className="bg-white">
            ...
            <CardContent>
              ...
              <p className="text-slate-600 italic">
                ...
                Вы saved me 3.5 млн рублей вложений и годы жизни! Теперь рассматриваю другой вариант — и сразу с вашим аудитом»
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white">
            ...
            <CardContent>
              ...
              <p className="text-slate-600 italic">
                ...
                прибыль на 2 месяца раньше. Спасибо за уверенность и реальный инструмент для переговоров».
              </p>
            </CardContent>
          </Card>
